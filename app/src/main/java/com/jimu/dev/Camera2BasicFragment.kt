...
//
//class Camera2BasicFragment : Fragment(), View.OnClickListener, OnRequestPermissionsResultCallback {
//    companion object {
//        /**
...
//        mTextureView = AutoFitTextureView(activity)
...
//        val bufferRect = RectF(0, 0, mPreviewSize!!.height.toFloat(), mPreviewSize!!.width.toFloat())
