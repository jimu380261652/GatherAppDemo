...
//
//  // Configure your oauth related parameters here
//  private static final String FDS_BASE_URI = "https://files.fds.api.xiaomi.com";
//  private static final String APP_ID = "your_app_id";
//  private static final String OAUTH_APP_ID = "your_oauth_app_id";
//  private static final String OAUTH_PROVIDER = "XiaoMi";
//  private static final String OAUTH_MAC_ALGORITHM = "HmacSHA1";
//  private static final String OAUTH_MAC_KEY = "your_oauth_mac_key";
//  private static final String OAUTH_ACCESS_TOKEN = "your_oauth_access_token";
//
//  private static final String BUCKET_NAME = "your_bucket";
//
//  public static void main(String[] args) throws Exception {
//    GalaxyFDSCredential credential = new OAuthCredential(FDS_BASE_URI,
